const users = [
  ...
  users.filter(function(name){ return name ===  letter})
  users.map(function(name){ return name})
function greet(){
    console.log(`Hello there, ${this.name}`/n)
}
let intervalid=setTimeout(greet,2000)
clearInterval(intervalid)

let choosenid=Number(prompt("Enter a userID:"))
todos.filter(function(todo){
 if (todo.userId===choosenid){
    return todo.completed !== false
 }
}
)
//Hello my brain is totally fried, I have tried a couple of times to do the exercise right but nothing
//I know i have a million mistakes but I pushed the code so that you can see that I tried even though it is a complete mess
//I will listen to the revision of the code today and hopefully I figure it out 